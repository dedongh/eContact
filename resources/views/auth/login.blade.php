    ...
    <div class="mx-auto h-full flex justify-center items-center bg-gray-300">
        <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
            ...
            <form method="POST" action="{{ route('login') }}" class="pt-8">
                ...
                <div class="relative">
                    <label for="email"
                           class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">Email</label>
                ...
                <div class="relative pt-3">
                    ...
                    <div class="">
                        <input id="password" type="password"
                               class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700 @error('password') is-invalid @enderror" name="password" required
                ...
                <div class="pt-8">
                    <button type="submit" class="w-full bg-gray-400 py-2 px-3 uppercase rounded text-blue-800 font-bold">
                        Login
                    </button>
                </div>
